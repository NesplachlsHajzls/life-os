  ...
  return (
    <div className="flex-1 overflow-y-auto px-5 py-4 pb-20">
      ...
      <div className="space-y-2">
        {workouts.map(w => (
          <div key={w.id} className="rounded-[12px] border border-[var(--border)] p-3 bg-[var(--surface)] flex items-start justify-between">
      ...
      {showAdd && (
        <div className="fixed inset-0 bg-black/30 flex items-end z-50">
          <div className="w-full bg-[var(--surface)] rounded-t-[20px] p-5 space-y-4">
            ...
            <input type="text" placeholder="Název" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} className="w-full px-4 py-2.5 border border-[var(--border-strong)] rounded-[10px] text-[14px]" />
            <input type="date" value={form.date} onChange={(e) => setForm({ ...form, date: e.target.value })} className="w-full px-4 py-2.5 border border-[var(--border-strong)] rounded-[10px] text-[14px]" />
      ...
      {showAdd && (
        <div className="fixed inset-0 bg-black/30 flex items-end z-50">
          <div className="w-full bg-[var(--surface)] rounded-t-[20px] p-5 space-y-4">
            ...
            <select value={form.meal_type} onChange={(e) => setForm({ ...form, meal_type: e.target.value as any })} className="w-full px-4 py-2.5 border border-[var(--border-strong)] rounded-[10px] text-[14px]">
      ...
      {showAdd && (
        <div className="fixed inset-0 bg-black/30 flex items-end z-50">
          <div className="w-full bg-[var(--surface)] rounded-t-[20px] p-5 space-y-4">
            ...
            <input type="text" placeholder="Dávka" value={form.dose} onChange={(e) => setForm({ ...form, dose: e.target.value })} className="w-full px-4 py-2.5 border border-[var(--border-strong)] rounded-[10px] text-[14px]" />
            <select value={form.timing} onChange={(e) => setForm({ ...form, timing: e.target.value as any })} className="w-full px-4 py-2.5 border border-[var(--border-strong)] rounded-[10px] text-[14px]">
